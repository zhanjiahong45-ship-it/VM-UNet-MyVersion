...
# --- 配置参数 ---
MODEL_PATH = '/root/root/VM-UNet/results/vmunet_isic18_Thursday_19_February_2026_15h_05m_06s/checkpoints/best-epoch134-loss0.2741.pth'
IMG_SIZE = 256
INPUT_DIR = 'inputs'
...
def preprocess_exact_author_logic(img_pil, target_size):
    ...
    # HWC -> CHW
    img_tensor = torch.from_numpy(img_final).permute(2, 0, 1).float()
