...
# [MODIFIED] Import the new V3 model
from models.vmunet.vmunet_exp3 import VMUNet
...
def main(config):
    # [MODIFIED] Changed suffix to _experimental_v3
    config.work_dir = config.work_dir[:-1] + "_experimental_v3/"
