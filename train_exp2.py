...
# [MODIFIED] Import from vmunet_exp2
from models.vmunet.vmunet_exp2 import VMUNet
...
def main(config):
    # [MODIFIED] Updated work directory to distinguish this experiment
    config.work_dir = config.work_dir[:-1] + "_DirectionalGDM_exp/"
