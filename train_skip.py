...
# [CHANGE] Import from vmunet_skip
from models.vmunet.vmunet_skip import VMUNet
...
def main(config):
    # [CHANGE] Update work directory suffix to distinguish this experiment
    config.work_dir = config.work_dir[:-1] + "_skip_gdm/"
    ...
    print('#----------Preparing Model (SkipGDM Enabled)----------#')
