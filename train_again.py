...
# [CHANGE] Import from vmunet_again
from models.vmunet.vmunet_again import VMUNet
...
def main(config):
    # [CHANGE] Updated suffix to distinguish this run
    config.work_dir = config.work_dir[:-1] + "_gdm_optimized/"
    ...
    print('#----------Preparing Model (GDM Optimized)----------#')
