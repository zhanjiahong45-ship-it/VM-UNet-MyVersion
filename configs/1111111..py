...
class setting_config:
    ...
    # ==========================================================
    # 核心修改：使用刚刚定义的 BceFocalTverskyLoss
    # wt=2 表示稍微加大 Focal Tversky 的权重，以重点攻坚小病灶
    criterion = BceFocalTverskyLoss(wb=1.0, wt=2.0, alpha=0.7, gamma=2.0)
    # ==========================================================
    ...
    distributed = False
    local_rank = -1
    # 核心修改 2：提高 DataLoader 速度
    num_workers = 4
    seed = 42
    world_size = None
    rank = None
    # 核心修改 3：开启混合精度训练，节省显存且可能提升泛化性
    amp = True
    gpu_id = '0'
    batch_size = 32
    epochs = 300
    ...
    best_ckpt_path = '/root/root/VM-UNet/results/vmunet_isic18_Thursday_05_March_2026_21h_42m_16s/checkpoints/best-epoch95-miou0.8244.pth'
